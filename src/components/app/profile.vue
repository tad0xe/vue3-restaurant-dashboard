            ...
            <div class="profile-head">
              ...
              <div class="profile-info">
                <div class="profile-photo">
                  <img
                    src="frontend/images/profile/profile.png"
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="profile-blog mb-5">
                <h5 class="text-primary d-inline">Today Highlights</h5><a
                  href="javascript:void()"
                  class="pull-right f-s-16"
                >More</a>
                <img
                  src="frontend/images/profile/1.jpg"
                  alt=""
              ...
              <div class="profile-interest mb-5">
                ...
                <div class="row mt-4">
                  <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                    ...
                    >
                      <img
                        src="frontend/images/profile/2.jpg"
                        alt=""
                        class="img-fluid"
                      >
                      <p>Shopping Mall</p>
                  ...
                  <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                    ...
                    >
                      <img
                        src="frontend/images/profile/3.jpg"
                        alt=""
                        class="img-fluid"
                      >
                      <p>Photography</p>
                  ...
                  <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                    ...
                    >
                      <img
                        src="frontend/images/profile/4.jpg"
                        alt=""
                        class="img-fluid"
                      >
                      <p>Art &amp; Gallery</p>
              ...
              <div class="profile-news">
                ...
                <div class="media pt-3 pb-3">
                  <img
                    src="frontend/images/profile/5.jpg"
                    alt="image"
                    class="mr-3 rounded"
                    width="75"
                  >
                ...
                <div class="media pt-3 pb-3">
                  <img
                    src="frontend/images/profile/6.jpg"
                    alt="image"
                    class="mr-3 rounded"
                    width="75"
                  >
                ...
                <div class="media pt-3 pb-3">
                  <img
                    src="frontend/images/profile/7.jpg"
                    alt="image"
                    class="mr-3 rounded"
                    width="75"
                  >
                    ...
                    >
                      <div class="my-post-content pt-3">
                        <div class="post-input">
                          ...
                          <a
                            href="javascript:void()"
                            class="btn btn-primary light mr-1 px-3"
                          ><i class="fa fa-camera"></i> </a><a
                            href="javascript:void()"
                        ...
                        <div class="profile-uoloaded-post border-bottom-1 pb-5">
                          <img
                            src="frontend/images/profile/8.jpg"
                            alt=""
                            class="img-fluid"
                          >
                          <a
                        ...
                        <div class="profile-uoloaded-post border-bottom-1 pb-5">
                          <img
                            src="frontend/images/profile/9.jpg"
                            alt=""
                            class="img-fluid"
                          >
                          <a
