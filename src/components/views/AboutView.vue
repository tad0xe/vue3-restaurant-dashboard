        ...
        <div class="container">
          ...
          <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-none d-lg-block">
              ...
              <p class="mb-0">Welcome string Eatio Admin!</p>
            </div>
            ...
            <div class="dropdown custom-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a
                  class="dropdown-item"
                  href="#"
                >4 June 2020 - 4 July 2020</a>
                <a
                  class="dropdown-item"
                  href="#"
                >5 july 2020 - 4 Aug 2020</a>
              </div>
            </div>
          </div>
          <div class="row">
                ...
                <div class="card-body p-4">
                  <div class="media ai-icon">
                    ...
                    <div class="media-body">
                      ...
                      <small>{{totalUserPercent}}% (30 days)</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card ">
                ...
                <div class="card-body orders-summary">
                  <div class="d-flex order-manage p-3 align-items-center mb-4">
                    <a class="btn fs-22 py-1 btn-success px-4 mr-3">25</a>
                    <h4 class="mb-0">New Orders <i class="fa fa-circle text-success ml-1 fs-15"></i></h4>
                    <a class="ml-auto text-primary font-w500">Manage orders <i class="ti-angle-right ml-1"></i></a>
                  </div>
                  <div class="row">
                    <div class="col-sm-4 mb-4">
                      <div class="border px-3 py-3 rounded-xl">
                        <h2 class="fs-32 font-w600 counter"> {{ onDeliveryCount }}</h2>
                        <p class="fs-16 mb-0">On Delivery</p>
                      </div>
                    </div>
                    <div class="col-sm-4 mb-4">
                      <div class="border px-3 py-3 rounded-xl">
                        <h2 class="fs-32 font-w600 counter"> {{ deliveredCount }}</h2>
                        <p class="fs-16 mb-0">Delivered</p>
                      </div>
                    </div>
                    <div class="col-sm-4 mb-4">
                      <div class="border px-3 py-3 rounded-xl">
                        <h2 class="fs-32 font-w600 counter">{{ cancelledCount }}</h2>
